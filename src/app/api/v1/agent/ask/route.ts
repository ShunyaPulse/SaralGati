    ...
    if (!finalResult) {
      ...
      const findUIIndex = (
        ...
        const isNoise = (txt: string) => {
          return (
            /\b\d+\s*(videos?|photos?|messages?|audios?)\b/i.test(txt) ||
      ...
      if (safeAppPackage === "com.whatsapp") {
        ...
        safeAppPackage.includes("facebook") ||
        safeAppPackage.includes("katana")
      ) {
        if (
        ...
        safeAppPackage.includes("photos") ||
        safeAppPackage.includes("gallery")
      ) {
        if (
        ...
        safeAppPackage.includes("messaging") ||
        safeAppPackage.includes("sms")
      ) {
        if (
          questionLower.includes("message") ||
